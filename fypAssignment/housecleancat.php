...
$sql = "SELECT * FROM product WHERE category='Household and Cleaning'";
$house_cat = $connection->query($sql);
...
<div class="navigation">
    ...
    <ul id='menu'>
        <li><?php
            ...
            echo $u_name[0];
            ?></li>
        <li><a href='shoppingCart.php'>Shopping cart: <?php echo $total;?></a></li>
...
<head>
    <title> Household and cleaning   </title>
</head>
<div class="full_page">
    ...
    <div class="main-container">
        <main>
            ...
            <?php
            while($row = mysqli_fetch_assoc($house_cat)){
